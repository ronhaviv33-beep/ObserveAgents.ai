...
export const ROLES = {
  ...
  analyst: { label:"Analyst", color: T.warn,   pages: ["dashboard","welcome","agent_inventory","discovery","governance","relationship_map","runtime","intelligence","guardrails","cost","security_intel","ecosystem","budgets","pricing","home","overview","agents","models","workflows","alerts","assets","chat","integrations","onboarding"],                                          can: [], team_scoped: true },
  viewer:  { label:"Viewer",  color: T.info,   pages: ["dashboard","welcome","agent_inventory","discovery","governance","relationship_map","runtime","intelligence","guardrails","cost","security_intel","ecosystem","budgets","pricing","home","overview","agents","models","workflows","alerts","assets"],                                                                             can: [], team_scoped: true },
};

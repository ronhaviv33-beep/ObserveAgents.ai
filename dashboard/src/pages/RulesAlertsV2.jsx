...
const RULE_TEMPLATES = [
  ...
  { type: "ai_workload_missing_owner", title: "Optional owner metadata",
    category: "governance", severity: "info", implemented: false,
    trigger: "An AI workload has no owner/team metadata yet.",
    action: "Optional owner/team metadata improves attribution and routing.",
    gateway: "never a candidate on its own" },

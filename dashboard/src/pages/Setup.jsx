  ...
  return (
    <div style={{ border: `1px solid ${T.border}`, borderRadius: 8, overflow: "hidden", marginBottom: 12 }}>
      <div style={{ padding: "8px 14px", background: T.panelHi, display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <button onClick={copy}
          style={{ background: "transparent", border: `1px solid ${T.border}`, color: copied ? T.ok : T.textMute,
  ...
  otlphttp/observeagents:
    ...
    headers:
      ...
      <SetupStep n={4} title="Recommended: follow the GenAI semantic conventions">
        Discovery works from <code style={{ fontFamily: FONT_MONO, color: T.info, fontSize: 11 }}>service.name</code> alone — these attributes make discovery richer and attribution more precise.
        ...
        <div style={{ position:"relative", borderTop:`1px solid ${T.border}` }}>
          ...
          <button onClick={() => copy(id, snippet)}
            style={{ position:"absolute", top:8, right:8, background:"transparent", border:`1px solid ${T.border}`,
              color:copied===id?T.ok:T.textMute, borderRadius:4, padding:"3px 10px", fontSize:10, fontFamily:FONT_MONO, cursor:"pointer" }}>
    ...
    <div style={{ maxWidth:900, margin:"0 auto", padding: bp.isMobile ? "16px" : "32px 24px", fontFamily:FONT_UI }}>
      ...
      <div style={{ marginBottom:16, padding:"16px 24px",
        ...
        <button
          ...
          style={{ background:T.accent, color:"#04121D", border:"none", borderRadius:6,
      ...
      <div style={{ background:T.panel, border:`1px solid ${T.border}`, borderRadius:10, padding:"16px 24px", marginBottom:28 }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns: bp.isMobile ? "repeat(2,1fr)" : "repeat(4,1fr)", gap: bp.isMobile ? 16 : 0 }}>
          {[
            ...
            { label:"Dependencies",      value:fmtMetric(metrics.dependencies), color:T.teal },
